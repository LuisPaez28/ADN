...
#Creo el 3'
    ...
    for q in range(3):
        posibilitis = [a,t,c,g]
        if cinco[q] == posibilitis[0]:
            tres[q] = posibilitis[1]
        if cinco[q] == posibilitis[1]:
            tres[q] = posibilitis[0]
        if cinco[q] == posibilitis[2]:
            tres[q] = posibilitis[3]
        if cinco[q] == posibilitis[3]:
            tres[q] = posibilitis[2]
    borrador = turtle.Turtle()
    borrador.pencolor('gray')
    borrador.color('gray')   
    if isfirst == False:
        borrador.penup()
        borrador.pensize(2)
        borrador.forward(200)
        borrador.pendown()
        borrador.begin_fill()
        borrador.left(90)
        borrador.forward(inicioBorrador)
        borrador.right(90)
        borrador.forward(300)
        borrador.right(90)
        borrador.forward(inicioBorrador)
        borrador.right(90)
        borrador.forward(300)
        ...
        borrador.forward(200)
        borrador.left(90)
        borrador.forward(inicioBorrador-40)
        borrador.pendown()
        borrador.begin_fill()
        borrador.left(90)
        borrador.forward(inicioBorrador)
    ...
    for ii in range(4):
        ...
        fosf.left(90)
        fosf.pendown()
        fosf.forward(inicioBienPartes+2)
        ...
        nucleo.left(90)
        nucleo.pu()
        nucleo.forward(inicioBienPartes)
        nucleo.right(90)
        nucleo.forward(190)
        nucleo.pendown()
        nucleo.pencolor(usarColor)
